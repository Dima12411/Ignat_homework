...
function HW8() {
    ...
    const checkOfLegalAge = () => setPeople(homeWorkReducer(initialPeople, {type: "CHECK-OF-LEGAL-AGE", payload: 18}))
    ...
    return (
        <div>
            ...
            <div className={s.buttons}>
                ...
                <SuperButton onClick={checkOfLegalAge}>check 18</SuperButton>
            </div>
